  ...
  return (
    <header
      className={clsx(
        ...
        isScrolled
          ? 'dark:bg-neutral-800/95 dark:backdrop-blur dark:[@supports(backdrop-filter:blur(0))]:bg-neutral-900/75'
          : 'dark:bg-transparent'
      )}
    >
        ...
        <div className="relative flex flex-grow basis-0 items-center">
          {/* <div className="hidden flex-col lg:flex">
            <Link href={`/${page.product.path}`}>
              ...
              {console.log(page.product)}http://localhost:3000/_next/static/media/blur-cyan.d28a5585.png
            </Link>
          </div>
