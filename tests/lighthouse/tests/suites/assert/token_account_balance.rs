...
use lighthouse::types::{Assertion, Operator};
    ...
    let mut tx_builder = program.create_assert_multi(
        ...
        vec![
            Assertion::TokenAccountField(
                lighthouse::types::TokenAccountDataField::Amount(0),
                Operator::GreaterThan,
            ),
            Assertion::TokenAccountField(
                lighthouse::types::TokenAccountDataField::Amount(101),
                Operator::LessThan,
            ),
            Assertion::TokenAccountField(
            ...
            Assertion::TokenAccountField(
                lighthouse::types::TokenAccountDataField::Amount(99),
                Operator::NotEqual,
            ),
        ],
        vec![token_account],
